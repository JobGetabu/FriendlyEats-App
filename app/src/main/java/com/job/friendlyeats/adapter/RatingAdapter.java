...
import com.job.friendlyeats.model.Rating;
...
public class RatingAdapter extends FirestoreAdapter<RatingAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext())
                .inflate(com.job.friendlyeats.R.layout.item_rating, parent, false));
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(com.job.friendlyeats.R.id.rating_item_name)
        TextView nameView;

        @BindView(com.job.friendlyeats.R.id.rating_item_rating)
        MaterialRatingBar ratingBar;

        @BindView(com.job.friendlyeats.R.id.rating_item_text)
        TextView textView;
