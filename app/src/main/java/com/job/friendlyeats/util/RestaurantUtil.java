 ...
 */
 package com.job.friendlyeats.util;
...
public class RestaurantUtil {
    ...
    public static Restaurant getRandom(Context context) {
        ...
        String[] cities = context.getResources().getStringArray(com.job.friendlyeats.R.array.cities);
        cities = Arrays.copyOfRange(cities, 1, cities.length);

        // Categories (first element is 'Any')
        String[] categories = context.getResources().getStringArray(com.job.friendlyeats.R.array.categories);
